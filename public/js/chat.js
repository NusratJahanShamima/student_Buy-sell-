...
const receiver_id = params.get('seller_id') || params.get('receiver_id');

if (product_id && receiver_id) {
    currentProduct = product_id;
    currentReceiver = receiver_id;
    document.getElementById('chatUser').innerText = "Chat";
    loadMessages();
}
...
function loadConversations() {
    ...
    fetch(`${API}/api/messages/conversations/${user_id}`)
        .then(res => res.json())
        .then(data => {
...
function loadMessages() {
    ...
    fetch(`${API}/api/messages?user_id=${user_id}&product_id=${currentProduct}`)
        .then(res => res.json())
        .then(data => {
