            ...
            const card = `
                <div class="col-md-4 mb-4">
                    <div class="card shadow-sm h-100">
                        ...
                        <img src="${API}/uploads/${product.image}" class="card-img-top">
...
function contactSeller(productId, sellerId) {
    ...
    window.location.href = `chat.html?product_id=${productId}&receiver_id=${sellerId}`;
}
